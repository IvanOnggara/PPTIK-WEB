  ...
  <div>
	<div>
	  ...
	  <div class="text-center">
		...
		<b><p style="color: red;text-align: center;font-size: 1.2em;margin-bottom: 5px; stroke: 2px black">{{ session('statusRegister') }}</p></b>
		
		@endif

		@if(session('statusRegisterSukses'))
		
		<b><p style="color: green;text-align: center;font-size: 1.2em;margin-bottom: 5px; stroke: 2px black">{{ session('statusRegisterSukses') }}</p></b>
